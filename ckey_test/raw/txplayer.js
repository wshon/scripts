...
!function (a) {
    ...
    function d(a) {
        ...
        z.dataset.platform = e.getPcPlatformId(z.config),
            z.dataset.sdtfrom = e.getStdfrom(z.dataset.platform, z.config),
            z.dataset.txplayerAuth = new q,
            z.dataset.txplayerAuth.setData(z.config.authData),
        g.businessId && (z.dataset.businessId = g.businessId, "200" == z.dataset.businessId && (z.dataset.businessId = "6"), "201" == z.dataset.businessId && (z.dataset.businessId = "11")),
            z.config.playerId = f.getPlayerId(g),
            z.dataset.playerId = z.config.playerId,
            !g.guid && e.browser.macqqlive ? f.getUserIdForMacClientAsync(function (a) {
                a && a.guid && (z.config.guid = a.guid, z.dataset.guid = z.config.guid)
            }) : (
                z.config.guid = f.getUserId(g), z.dataset.guid = z.config.guid
            ),
            z.dataset.flowid = z.dataset.playerId + "_" + z.dataset.platform;
        var A = f.getUnid();
    ...
    var d = {
        getHlsAdOffsetTime: function (a, b, c) {
            ...
            var b = "";
            return /ptag=wx\.search/i.test(location.href) ? 64 : a && a.hasOwnProperty("chid") && "" != a.chid ? a.chid : (/(.*\.)3g\.qq\.com$/i.test(window.location.hostname) ? b = 13 : /(.*\.)?v\.qq\.com$/i.test(window.location.hostname) || d.browser.qqlive ? b = d.browser.wechat && d.mobile ? 180 : 0 : d.browser.wechat && window.location.href.indexOf("/x/qqnews/") > -1 ? b = 3 : d.browser.mqq && window.location.href.indexOf("/x/qqnews/") > -1 ? b = 10 : d.browser.qqnews && (b = 2), b)
